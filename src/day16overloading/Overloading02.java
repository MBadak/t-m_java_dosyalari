...
public class Overloading02 {
	...
	// java methotlarýn farklý olup olmadýklarýný anlamak için iki þeye bakar
	// a) method ismine b) parametrelerine

//	public static int çarpma(int num1,int num2) {
//		System.out.println(num1*num2);
//	}
//	private static int çarpma(int num1,int num2) {
//		System.out.println(num1*num2);
//	}
//	private static int çarpma(int num1,int num2) {
//		System.out.println(num1*num2);
...
//	}
	...
	// Note 2: Access Modifier'lari degistirmek de method'lari Java acisindan farkli
	// hale getirmez.
	// Cunku access modifier'lar method signature'a dahil degildir.
	// Note 3: Method'larin body'sini degistirmek de method'lari Java acisindan
	// farkli hale getirmez.
	// Cunku body'ler method signature'a dahil degildir.
	// Note 4: Siz daha kodu yazarken yani kodu calistirmadan once Java sizi
	// yaptiginiz hatalardan dolayi
	// uyarirsa bu tip hatalara "Compile Time Error" denir.
	// Note 5: Kodu yazarken herhangi bir hata yok fakat kodu calistirdiktan sonra
	// console'da
